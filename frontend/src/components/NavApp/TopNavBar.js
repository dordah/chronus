    ...
    <div>
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        ...
        <Nav className="mr-auto">
          ...
          <Nav.Link as={NavLink} to="/MainTradeRoom">
            Trade Room
          </Nav.Link>
          <Nav.Link as={NavLink} disabled={isLoggedIn === false} to="/Profile">
            Profile
          </Nav.Link>
          <Nav.Link
            as={NavLink}
        ...
        <Nav>
          <Nav.Link as={NavLink} to="/AboutOurTeam">
            About Our Team
          </Nav.Link>
          <Nav.Link
            as={NavLink}
            eventKey={2}
            to={isLoggedIn ? "/Home" : "/MainRegisterPage"}
          >
            {" "}
